...
if(isset($_POST['submit']) && $_POST['submit']=='Submit')
{
	...
	$data=array($conf_pass,$user_id);

	$res=$obj->Updatepassword($data); 
	if($res==1)
	{
                $_SESSION['user']['pass']="Change Password Successfully";
...
<form name="frm_search" id="frm_search" action="" method="post">
     <input type="password" id="old_pass" name="old_pass" placeholder="Old Password"> <p id="passMsg"></p>
...
<script>
	   ...
	   $( "#old_pass" ).change(function() {
		   pass=$("#old_pass").val();
		   $.post("getChangePass.php?pass="+pass, function( data ) {
			   $("#passMsg").html(data);
		   });
	  });
...
$("#submit").click(function ()
{
	...
	if(old_pass=='')
	{
		 alert("Please Enter Your Old Passwword");
		 return false;
	}
	if(new_pass=='')
	{
