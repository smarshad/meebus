...
<a href="counter_search.php" class="btn btn-primary" style="height:60px ; font-size:18px;">
CLICK FOR BOOK COUNTER TICKET</a>
                                 ...
                                 <div class="span4">
                                            <div class="control-group">
                                                 ...
                                                 <a href="search.php" class="btn btn-primary"  style="height:60px; font-size:18px;">CLICK FOR BOOK ONLINE TICKET</a>
                                            </div>
                               </div>
                            </div>
                        </div>
