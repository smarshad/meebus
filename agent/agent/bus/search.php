           ...
           <div class="span9" id="content">
                    	<div class="row-fluid">                        
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Search For Bus</div>
                            </div>
                            <div class="block-content collapse in">
								...
								if(isset($_SESSION['agent']['log']['api_select']) && $_SESSION['agent']['log']['api_select']!='')
								{
									if($_SESSION['agent']['log']['api_select']=='redbus')
										{
											?>
                                            <form action="searchresult.php" method="post" autocomplete="off" style="margin:0px !important;">
                                            <?php 
										}
									if($_SESSION['agent']['log']['api_select']=='ispace')
										{
												?>
                                                <form action="searchresults.php" method="post" autocomplete="off" style="margin:0px !important;">
                                                <?php 
										}
								}
					...
					?>
                                      ...
                                      <fieldset>
                                        ...
                                        <div class="span3">
                                            <div class="control-group">
                                             <input class="input sname focused" id="depart" name="depart"  type="text" placeholder="Depart Date" required value="" />
                                            </div>
                                        </div>
                                        <div class="span2">
                                            <div class="control-group">
