...
$data=array($_GET['ticket'],$status);
$ticket=$obj->getTicket1($data);
$ticket_html='';
...
<div class="row-fluid">
<div id="content" class="span2">&nbsp;</div>
...
foreach($ticket as $t)
{
	...
	if($t['id']>=4480)
	{
		...
		$boardingcontact="Contact No : ".$board['4'];
	...
	else
	{
		...
		$boardingcontact="Contact No : ".$t['travelsPhoneNbr'];
		} else { $boardingcontact=''; }
		...
		foreach($p_seat as $pass) { if($pass!='') { $passenger['seat'][]=$pass; } }
		$passenger_sex=$t['passenger_sex']; 
		$p_sex=explode('|A|',$passenger_sex); 
		foreach($p_sex as $pass){ $passenger['sex'][]=$pass; }
...
$getAgentDeatils = $obj->getAgentDeatils($agent_id);
//echo "<pre>"; print_r($getAgentDeatils); echo "</pre>";
...
<table width=100% border=0><tr><td width=15%>Agency Name</td><td width=35%>'.strtoupper($getAgentDeatils[0]['agency_name']).'</td><td width=50% align="right">Customer Support No : +91 95669 43649</td></tr><tr><td>Mobile</td><td>'.$getAgentDeatils[0]['mobile_phone'].'</td><td>&nbsp;</td></tr><tr><td>Email</td><td>'.$getAgentDeatils[0]['email'].'</td><td>&nbsp;</td></table></td></tr></table><br/></td></tr></tbody></table></td></tr></tbody></table><div class="yj6qo"></div><div class="adL"></div></div></div></div>'; 
...
voice_booking($mobileNbr); if($smsStatus1) { 
if($smsStatus2[0]==1701) { echo "<b>SMS Send Successfully</b><br/><br/><br/><br/>"; }
else  { echo "<b>SMS Send Statu Pending</b><br/><br/><br/><br/>"; } }
else  { echo "<b>SMS Not Send Please Resend Again</b><br/><br/><br/><br/>"; }*/
?>
</div>
</div>
</div>
