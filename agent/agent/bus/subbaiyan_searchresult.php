...
<?php include_once '../includes/top_menu.php'; ?>
             ...
             <?php include '../includes/leftmenu.php'; ?>
                ...
                <div class="span9" id="content">
                    <div class="row-fluid">
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted text-center"><?php echo ucfirst($_SESSION['agent']['bus']['origin'])." -> ".ucfirst($_SESSION['agent']['bus']['destination'])." (".$_SESSION['agent']['bus']['travelDate'].")"; ?></div> 
                            </div>
                                ...
                                <div class="span12">
                                     <div id="page-wrap">
                                        <table id="bus">
											...
											$i=1;foreach($results['availableTrips'] as $bus_result) {  ?>
        ...
        <strong>mTicket</strong>
                                                   ...
                                                   <a href="#" class="tooltip1"> 
                                                    <span class="sub-title"><?php echo $Depart_time=date("g:i A", strtotime(floor($bus_result['departureTime'] / 60) . ":" . $bus_result['departureTime'] % 60)); ?></span>
													...
													if(is_array($obj->agentMarkup($bus_result['fares'],$agent_markup,$admin_markup))) {
                                                     ...
                                                     <span><a class='book' id="<?php echo $bus_result['id']; ?>" href="javascript:void(0);">Book</a></span>
                                                     <?php
														}
														else
														{
