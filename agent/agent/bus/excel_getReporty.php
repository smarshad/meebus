...
<?php if(isset($getCommData[0]['remark']) && $getCommData[0]['remark']!='' && $getCommData[0]['remark']=='Ticket Booked' && $agent_report['status']=='BOOKED') { ?>
                                                <img src="images/email.png" onClick="return resendEmail('<?php echo $agent_report['tiket_no']; ?>');" width="20"/><br>
                                                <img src="../images/sms.png" onClick="return sendsms('<?php echo $agent_report['tiket_no']; ?>');" width="20"/><br>
                                                <?php } ?>
                                                </td>
                                                <td class="center">
												<?php 
