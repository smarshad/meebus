...
function saveImageOrder(vipseat,vipfares,buss_id)
{
	//alert(vipfares.value);
...
<!--document.getElementById('debug').innerHTML = 'This is the new order of Your seat : <br>'+orderString;-->
	document.getElementById("debug").innerHTML+="<a href='seat_layout.php?exists&val2="+orderString+"&busid="+buss_id+"&vipseatsel="+vipseat.value+"&vipfare="+vipfares.value+"' onclick='' style='color: coral; text-decoration: none;'>FIX THIS STRUCTURE</a>";
