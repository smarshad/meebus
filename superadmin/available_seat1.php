...
if(isset($_REQUEST['bus_id']) && isset($_REQUEST['dat']) && isset($_REQUEST['trip'])){
...
<form name="form" action="booker_details.php" method="post">
			...
			$row=mysql_fetch_array($sel);
					...
					<tr><td colspan="2">&nbsp;</td></tr>
						<tr>
						<td colspan="2" align="center">						
						<input type="button" id="back" name="back" value="&lt;&lt; Back " onclick="window.location.href='bookingmgnt.php'" />
						<input type="submit" id="submit" name="submit" value=" Continue &gt;&gt;" onclick="return validate_seats();" />						
						</td>
						</tr>
					</table>
					</form>
