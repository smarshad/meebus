...
$bus_id = $_SESSION['book_var']['bus_id'];

$selbus=mysql_fetch_array(mysql_query("SELECT * FROM businfo WHERE Bus_id='$bus_id'"));
...
$paypalmail=$paypal;
$x_ordid=base64_encode($_SESSION['ticket_id']);

$product_price=currency('INR','USD',$_SESSION['book_var']['total_amt']);

$item_number=$_SESSION['ticket_id'];
$item_name=$selbus['Bus_name']." Bus Ticket";

$return_url=$site_url."paypal/success.php?tidd=$x_ordid";
$cancel=$site_url."paypal/cancel.php?tidd=$x_ordid";

//echo "<br>".$item_name."<br>".$item_number."<br>".$formaction."<br>".$paypalmail."<br>".$x_ordid."<br>".$product_price."<br>".$return_url."<br>".$cancel;
