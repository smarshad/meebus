...
<table width="100%">
	<tr>		
	  ...
	  <td>
	  Bus Type: <select name="bus_type" id="bus_type" onChange="searchBus();">
	  ...
	  <td>From: <select name="from_bus" id="from_bus" onChange="searchBus();">
	  ...
	  <?php
	   ...
	   <td>To: <select name="to_bus" id="to_bus" onChange="searchBus();">
	  <option value="-1">None</option>
	   <?php
	  ...
	  <td>Status: <select name="bus_status" id="bus_status" onChange="searchBus();">
	  <option value="-1">None</option>
