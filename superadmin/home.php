...
<fieldset class="table-bor">
		<legend><strong>Tickect Statistics</strong></legend> 		
			...
			$sql1="SELECT * FROM bookinginfo WHERE cancelledStatus = 0  and booked_date='$dat1'";
			$sql2="SELECT * FROM bookinginfo WHERE cancelledStatus = 0  and (booked_date between '$dat4' and '$dat1')";
			$sql3="SELECT * FROM bookinginfo WHERE cancelledStatus = 0  and (booked_date between '$dat6' and '$dat1')";
			$sql4="SELECT * FROM bookinginfo WHERE cancelledStatus = 0  and (booked_date between '$dat8' and '$dat1')";
			...
			Individual service providers tickect Sold Count</td>
			</tr>
			<?php
			...
			{
			$sp=mysql_fetch_array(mysql_query("SELECT * FROM bookinginfo WHERE cancelledStatus = 0 and SP_id='$ser_row[SP_id]'"));
			$sp_count=mysql_num_rows(mysql_query("SELECT * FROM bookinginfo WHERE cancelledStatus = 0 and SP_id='$ser_row[SP_id]'"));
			 ?>
			<tr>
			<td width="8%">&nbsp;</td>
	...
	<tr>
	<td colspan="5" style="font-weight:bold;">
	Bar Graph between Ticket sale and Agenices
	</td>
	</tr>
	...
	<tr>
	<td colspan="5" style="font-weight:bold;">
	Ticket Sale Graph of bus.com.bd
	</td>
	</tr>
