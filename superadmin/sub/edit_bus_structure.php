							...
							<td valign="top">						
								<table cellpadding="3" cellspacing="5" border="0" width="100%" bgcolor="#FFFFFF" id="chk_seats">
									...
									<?php }
									 ...
									 ?>
									 <input type="<?php if(!in_array($r,$seats)){ echo 'text'; } else { echo 'hidden'; }?>" name="<?php echo "seat_".$r ?>" id="<?php echo "seat_".$r ?>" size="2" maxlength="2" <?php if(in_array($r,$seats)){ ?> value="xx"  <?php } else {?> value="<?php echo $seat->seat_no; ?>" <?php } ?> onkeydown="return AllowcharNum(event)" />
									 <?php
									 }									 
									   }
										echo "</tr>";
