		 ...
		 if(isset($_SESSION['book_var']['book']) && $_SESSION['action']==0)
           {  
			...
			for($i=1; $i<=$tot_seat; $i++)
			{
				...
				$qry = mysql_query("insert into bookinginfo (auto_id, SP_id, Bus_id, SeatNo, travelling_date, booked_date, Ticket_ID, userid, usertype, cancelledStatus, Blocked, BlockedBy, BlockedType, PaymentType ) values ('','".$SP_id."', '".$Bus_id."', '".$_SESSION['book_var'][$seat_num]."', '".$dat."', NOW(), '".$ticket_id."', '".$accessing_LogID."', '".$accessing_type."', '0', '0', '0', '0', '".$payment."' ) ");
...
//echo $email."<br>".$subject."<br>".$msg."<br>".$headers;  exit;
	...
	$msg_print='<div style="width:750px; height:597px; background-color:#fff; border:10px solid rgb(165, 220, 255);  margin:0px; padding:0px;">
...
<div style=" width:720px; height:auto;border:1px solid #B7E3FF; background:#F3FBFF; margin:10px 15px ; ">
		...
		<td height="31" colspan="9" align="left" nowrap="nowrap"><b style="font-size:15px;color:#0066FF; ">Booking Details</b></td>
						...
						<tr>
							...
							<td valign="top">:</td>
							<td valign="top" nowrap="nowrap">'.get_booker($trow->Ticket_ID).'</td>
					...
					<tr>
							<td>&nbsp;</td>
							<td valign="top" nowrap="nowrap"><b>Service Provider </b></td>
							<td valign="top">:</td>
							<td valign="top" nowrap="nowrap">'.get_SP($trow->SP_id).'</td>
							<td valign="top"></td>
							<td valign="top" nowrap="nowrap"><b>Type</b></td>
							<td valign="top">:</td>
							<td valign="top" nowrap="nowrap">'.get_bus_type($trow->Bus_type).'</td>
							<td>&nbsp;</td>
						</tr>
