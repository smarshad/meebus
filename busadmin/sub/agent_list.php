...
$query .= " ORDER BY agency_name LIMIT $start, $per_page";
//echo $query;
...
$msg .='<div class="data">&nbsp;<br><table border="0" width="50%" cellspacing="2" cellpadding="5" align="center">
  ...
  $g=0;
		...
		$msg.='
		<tr>
			<td align="left">'.$agency_name.'<input type="hidden" id="'.$agent_id.'" value="'.$agency_name.'"></td>
			
			
			
			<td align="left" nowrap="nowrap">
						
			<a href="../assign_bus.php?agent_id='.$agent_id.'" title="Edit">
            ...
            $msg.='<tr>
			<td colspan="2" align="center"><span class="err_msg">No Agent.</span></td>
		  </tr>';	
	}	
	$msg.= "</table></div>" ;
...
$query_pag_num = "SELECT COUNT(*) AS count FROM agents where status='yes' ";

if(isset($_REQUEST['search']) && $_REQUEST['search']!=''){
  $search=mysql_real_escape_string($_REQUEST['search']);
  $query_pag_num .=" WHERE ";
  $query_pag_num .=" `agency_name` LIKE '%".$search."%' ";  
  }
