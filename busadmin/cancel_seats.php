...
<fieldset class="table-bor">
		...
		$tcity = ucwords($scount13['city_name']) ;
			...
			<a href="cancel_seats.php?proceed&ticketid=<?php echo $ticket; ?>&sp_id=<?php echo $_REQUEST['SP_id']; ?>" class="ovalbutton"><span><strong>Refund</strong></span></a><?php } ?>
			
			<input type="button" name="back" id="back" value=" Back " onClick="window.location.href='cancelled_tickets.php'">
				</td>
				</tr>
				</form>
				</table>
