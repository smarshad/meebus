...
if(isset($_REQUEST['block_sub']))
{
$bus_id=$_REQUEST['bus_id'];
$ser_id=$_REQUEST['sp_id'];
for($i=0;$i<count($_REQUEST['block']);$i++){
$block_id=$_REQUEST['block'][$i];
//echo "update bus_structure set block=1 where bus_id='$bus_id' and seat_no='$block_id'"; exit;
mysql_query("update bus_structure set block=1 where bus_id='$bus_id' and position='$block_id'");
}
header("location:busDetails.php?sp_id=$ser_id");			
}
...
//alert(v);
 ...
 if(v == 2){
	...
	document.getElementById('to_date').value=value;
...
<td>
<a href="javascript:void(0);" onclick="chgtab('1','document.getElementById(dat).value');" id="st" class="cssbutton active">Show Today</a></td><td><a href="javascript:void(0);" onclick="chgtab('2','document.getElementById(dat).value');" id="bo" class="cssbutton">Block in this day</a>
						...
						<tr>
							...
							<input type="text" name="to_date" id="to_date"/>
								<table cellpadding="3" cellspacing="5" border="0" width="100%" bgcolor="#FFFFFF" id="chk_seats">
									...
									<input type="checkbox" name="block[]" id="seat_<?php echo $seat_no; ?>" value="<?php echo $position; ?>"/>
									<script type="text/javascript">										
									...
									?>
									<tr><td align="center" colspan="10"><input type="submit" name="block_sub" id="block_sub" value="Block Seats" /></td></tr>																								
									</tbody>
								</table>							
							</td>
						</tr>
