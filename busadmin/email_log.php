...
<body onLoad="email_log();">

<fieldset class="table-bor">

		<legend><strong>Email Management</strong></legend> 
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="5">
			...
			<td><select name="filter" id="filter" onChange="email_log();" class="combobox-small">
			...
			<td>
			    <select name="bus" id="bus" onChange="email_log();" class="combobox-small">
				<option value="0">All</option>
				
				<?php  					
					$sql = mysql_query("select * from businfo where Bus_status='1' and SP_id='$_SESSION[SP_id]'") ;
