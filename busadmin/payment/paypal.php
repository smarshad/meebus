...
$paypalmail = "inetsolution_1293862441_biz@gmail.com";
...
$success = $site_url."/busadmin/view_ticket.php";
$fail = $site_url."/busadmin/pay_error.php";
...
<!-- Product Amount -->
<input type="hidden" name="amount" value="<?php echo $_SESSION['book_var']['total_amt']; ?>" />
