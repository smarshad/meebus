...
<tr><td height="47" colspan="3" style="font-size:14px; font-weight:bold; background-color:#EAF7FF; padding-left:20px;">Total Amount for Round Trip : Rs. <?php echo $totfare_tot=$total_tot; ?></td>
</tr>
</table>
				...
				<table width="99%" border="0" cellpadding="2" cellspacing="3" style="border:1px #666666 solid;">
				 ...
				 <tr><td colspan="5">&nbsp;</td></tr>
					...
					<tr>
					 ...
					 <a href="javascript:void(0)" onclick="discountcheq(form.promo_code.value,'<?php echo $SP_id; ?>','<?php echo $Bus_id; ?>','<?php echo $SP_id1; ?>','<?php echo $Bus_id1; ?>','<?php echo $totfare_tot; ?>','<?php echo $dat; ?>','<?php echo $dat1; ?>');"><input type="button" id="discount" name="discount" value=" Calculate Discount " /></a>
					  </td>
					</tr>
...
<tr><td colspan="3">&nbsp;</td></tr>
				...
				<input type="hidden" name="total_amt" id="total_amt" value="<?php echo $total_tot; ?>" >
