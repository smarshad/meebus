...
<body onLoad="search_agent();">
<fieldset class="table-bor">
<legend><strong>Agent Management</strong></legend>	
...
<table width="50%" border="0" cellspacing="1" cellpadding="1" align="center">
  <tr>
    <br />Search: <input type="text" name="search_agent" id="search_agent" onKeyUp="search_agent();"  class="textbox" />
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr>   
	<div id="loading"></div>
