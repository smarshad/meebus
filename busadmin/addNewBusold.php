...
$date=date("Y-m-d");
$ter_con=$_REQUEST['terms_conditions'];
...
$c=''; $d='';
	...
	/*echo "INSERT INTO `businfo` ( `Bus_id` ,`SP_id` ,`SR_id` ,`Bus_fromcity` ,  `Bus_tocity` ,  `Bus_type` ,  `Bus_structure` ,  `Bus_name` , `Bus_boarding_time` , `Bus_departure_time`,  `Bus_fare` ,  `Bus_adddate` ,  `Bus_seats4SP` ,  `Bus_seats4SA` ,  `Bus_totalseats` ,  `Bus_status`,`luxury_item`,`bus_video`) VALUES (NULL ,  '$SP_id',  '$SR_id',  '$source',  '$destination',  '$busType',  '$seats',  '$busname',  '$boarding_time', '$dropping_time',  '$total',  '$date',  '0',  '0',  '40',  '1','$item','$vimg')"; exit;*/
	
	$sql_businfo="INSERT INTO `businfo` ( `Bus_id` ,`SP_id` ,`SR_id` ,`Bus_fromcity` ,  `Bus_tocity` ,  `Bus_type` ,  `Bus_structure` ,  `Bus_name` , `Bus_boarding_time` , `Bus_departure_time`,  `Bus_fare` ,  `Bus_adddate` ,  `Bus_seats4SP` ,  `Bus_seats4SA` ,  `Bus_totalseats` ,  `Bus_status`,`luxury_item`,`bus_video`,`conditions`) VALUES (NULL ,  '$SP_id',  '$SR_id',  '$source',  '$destination',  '$busType',  '$seats',  '$busname',  '$boarding_time', '$dropping_time',  '$total',  '$date',  '0',  '0',  '40',  '1','$item','$vimg','$ter_con')";
...
/*	if(form.fare.value == ""){
	...
	for(var i=0;i<document.getElementById('boardcount').value;i++){
		...
		if(document.getElementById(bbt[0]).value == '')
		  {
		 // alert(document.getElementById(bbt[0]).value);
...
<table align="center">
	...
	<tr>
		...
		<tr>
			...
			<td width="20"><img src="../images/plus_icon.png" border="0" onClick="addRow('dataTable')" /></td>
			<td width="23"><img src="../images/minus_icon.png" border="0" onClick="deleteRow('dataTable')" /></td>
		</tr>
...
<tr>
		...
		<td colspan="3" align="left">
			...
			<div id="dp_0_err" style="display:none; color:#FF3300;">Please Enter Dropping Time</div>
					...
					<td width="20"><img src="../images/plus_icon.png" border="0" onClick="addRow1('dropping_tbl')" /></td>
					
					<td width="23"><img src="../images/minus_icon.png" border="0" onClick="deleteRow('dropping_tbl')" /></td>
	...
	<td>Luxury Items</td>
	<td>
	<select name="lux_item" id="lux_item" class="combobox">
	<option value="">Choose luxury item</option>
	<?php 
	...
	{
	?>
	<option value="<?php echo $lux_row['lux_id'];?>"><?php echo $lux_row['lux_name'];?></option>
	<?php } ?>
	</select>
   ...
   <!-- <img src="images/plus_icon.png" title="Add" border="0" onClick="javascript:AddDetails();" id="btnAdd"  />
	...
	<td><textarea cols="22" rows="4" name="terms_conditions" id="terms_conditions"></textarea></td>
	</tr>
