...
if(isset($_REQUEST['bus_id']) && isset($_REQUEST['dat'])){
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    //document.getElementById("err_seat").innerHTML=xmlhttp.responseText;
...
<form name="form" action="booker_details.php" method="post">
			...
			$row=mysql_fetch_array($sel);
			   ...
			   { ?>									
									<input type="checkbox" name="<?php echo "seat_".$row['seat_no']; ?>" id="<?php echo "seat_".$row['seat_no']; ?>"  value="<?php echo $row['seat_no']; ?>" onclick="seat_check(this.value,<?php echo $Bus_id; ?>,<?php echo $day; ?>,<?php echo $mon; ?>,<?php echo $year; ?>),seat_display(this.value)" /><?php } } 
									else {
									...
									<?php
											...
											else
											{
			                                  ...
			                                  {
									 ?>
									 <input type="checkbox" name="<?php echo "seat_".$row['seat_no']; ?>" id="<?php echo "seat_".$row['seat_no']; ?>"  value="<?php echo $row['seat_no']; ?>" onclick="seat_check(this.value,<?php echo $Bus_id; ?>,<?php echo $day; ?>,<?php echo $mon; ?>,<?php echo $year; ?>),seat_display(this.value)" />
									 <?php
