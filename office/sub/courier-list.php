...
$msg .='<div class="data"><table width="100%" border="0" cellspacing="2" cellpadding="5">
  ...
  if(mysql_num_rows($result_pag_data)>0)
  {
		...
		$msg.='<tr>
			<td align="left">'.$cons_no.'</td>
			<td align="left">'.$ship_name.'</td>
			<td align="left">'.$rev_name.'</td>
			<td align="left">'.$pick_date.'</a></td>
			<td align="left">'.$status.'</td>
			<td align="left">'.$contact_person.'</td>
			<td> <a href="edit-courier.php?cid='.$cid.'"><img src="../images/edit.png" border="0" title="View" /></a>	</td>
		  </tr>';
		}
    }
	else {
...
$query_pag_num = "SELECT COUNT(*) AS count FROM tbl_courier ";
