...
$query.=" GROUP BY bookinginfo.Ticket_ID ORDER BY bookinginfo.travelling_date DESC LIMIT $start, $per_page"; 
...
<table width="100%" border="0" cellspacing="2" cellpadding="5">
  ...
  if(mysql_num_rows($result_pag_data)>0)
  {
    $count=mysql_num_rows($result_pag_data);
		...
		$booked_date="";	
	//	echo "select * from businfo where Bus_id='$bus_id'"; exit;
		$bus_name = mysql_fetch_array(mysql_query("select * from businfo where Bus_id='$bus_id'")) ;
		
		$busname= $bus_name['Bus_name'];
