...
$dat6=date("Y-m-d",$dat5); 
  ...
  { 
  $flag=1;
  $query .=" where (email_date ='$dat1')"; 
  }
  else if($search =='2')
  {
  $flag=1;
   $query .=" where (email_date between '$dat4' and '$dat1')"; 
  }
   else if($search =='3')
  {
  $flag=1;
   $query .=" where (email_date between '$dat6' and '$dat1')"; 
  }
  else 
  {
   $query .=""; 
