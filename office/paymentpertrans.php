...
$sql6=mysql_fetch_array(mysql_query("SELECT * FROM businfo where bus_id='$_REQUEST[b_id]'"));
...
<table width="100%" cellpadding="3" cellspacing="10">
	<tr>
	    <td align="center"><font size="2"><strong>Service Provider Name :</strong> <?php echo ucfirst(get_SP_name($_REQUEST['sp_id'])); ?></font> <font size="2" style="float:right; padding-right:100px;"><strong>Bus Name :</strong> <?php echo ucfirst($sql6['Bus_name']); ?></font></td>
