...
else
{
	...
	$Ofcqry=mysql_query("SELECT * FROM tbl_courier_officers WHERE cid='$offid'");
	$officeDetails=mysql_fetch_array($Ofcqry);
	/*echo "<pre>";
	print_r($officeDetails);
	echo "</pre>";*/
	$officeLocationID=$officeDetails['location'];
	$officeLocationQuery=mysql_query("SELECT code,location FROM cargo_cities WHERE id='$officeLocationID'");
	$officeloc=mysql_fetch_array($officeLocationQuery);
...
<div class="bus-header">
	<div class="bus-container">
    	<img src="../images/redbus_logo.png" alt="busbooking" border="0" class="logo" style="height:70px;width:15%;" />
        <div class="head-right">
			<ul>
				<li class="user_thumb"><a href="#"><span class="icon"><img src="images/user_thumb.png" alt="User" height="30" width="30"></span></a></li>
				<li class="user_info"><span class="user_name"><?php echo ucfirst($_SESSION['office_name']); ?></strong></span></li>
