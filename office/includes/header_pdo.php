...
else
{
	...
	$officedet=$obj->getOfficeDetails(array($offid));
	$officedet=$officedet[0];
	$officeLocationID=$officedet['location'];
	$officeLocationQuery=$obj->getCargoCities(array($officeLocationID));
	$officeloc=$officeLocationQuery[0];
...
<div class="bus-header">
	<div class="bus-container">
    	<img src="../images/redbus_logo.png" alt="busbooking" border="0" class="logo" style="height:70px" />
