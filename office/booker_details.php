...
<form name="form" action="inter.php" method="post">
				...
				<tr>
					...
					<tr>
						<td><strong>Bus Fare :</strong> Rs. <?php echo $far=$query['Bus_fare'] ; ?> / member </td>
...
<tr><td colspan="3">&nbsp;</td></tr>
				...
				<input type="hidden" name="total_amtt" id="total_amtt" value="<?php echo $fare; ?> " >
				<input type="hidden" name="boading_point" id="boading_point" value="<?php echo $_REQUEST['boading_point']; ?>" >
				<input type="hidden" name="bus_fare" id="bus_fare" value="<?php echo $far; ?> " >
				...
				<tr><td colspan="5">&nbsp;</td></tr>
						...
						<tr><td colspan="2"><table border="0" cellspacing="0" cellpadding="5" width="80%" align="center">
            <tr>
            	<td width="10%" align="center">
            		<input type="radio" name="payment" id="cash" value="4" checked="checked" />
                </td>
                <td width="40%" align="left">
                	<label for="ccavenue" style="cursor:pointer;">Cash</label>
                </td>
                <td align="left">
                	<!--<img src="images/my.gif" border="0" alt="Through Credit Cards" title="Credit Cards" />-->
                    <script language='JavaScript'>
					function openLogo1(ClientID)
					{
                    ...
                    <!--<a href="javascript:openLogo('M_demo1_1828')">
                    	<img src="ccavenue/ccav_secure_banner.gif" border=0 width="120">
                    </a>-->
                </td>
            </tr>
        	<tr><td>&nbsp;</td></tr>
            <tr>
                ...
                <td align="left">
                	<!--<a href="https://www.paypal.com/webapps/mpp/paypal-popup" title="How PayPal Works" onClick="javascript:window.open('https://www.paypal.com/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;">--><img src="paypal/pp_logo.jpg" border="0" alt="PayPal Logo"><!--</a>-->
                	<!--<img src="images/paypal_tiny.gif" border="0" alt="Paypal" title="Paypal" />-->
                </td>
            </tr>
                            <?php $tmp_id = $_SESSION['user_id']; $select = "SELECT * FROM users WHERE user_id='$tmp_id' AND user_status='1'"; 
$query = mysql_query($select);
$result = mysql_fetch_object($query); 
$walletBalance = $result->balance;
if($fare<=$walletBalance) {  ?>
            <tr>
              <td height="60" align="center"><input type="radio" name="payment" id="paypal2" value="3" /></td>
              <td colspan="2" align="left">
                
              Your Wallet A/C Balance Is ( Rs: <?php echo $result->balance;?> )</td>
            </tr>
<?php } ?>            
            <tr>
              <td align="center">&nbsp;</td>
