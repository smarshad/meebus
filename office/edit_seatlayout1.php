...
if(isset($_POST['save'])){
	  ...
	  for($i=1;$i<=50;$i++)
	  {
		  ...
		  $vip=$_POST[$vp];
		  $seat=$_POST[$st];
		  mysql_query("INSERT INTO bus_structure (bus_id,position,seat_no,vip) VALUES ('$bid','$i','$seat','$vip')") or die(mysql_error());
	  }
...
<fieldset class="table-bor">
  ...
  <table width="382">
    <tr>
      ...
      <td><select name="bus_seatlayout" onchange="chg_structure(this.value)">
          <?php
        ...
        <div id="GalleryContainer">
          ...
          <div class="imageBox" id="<?php if(in_array($r,$seats)) { echo "xx";  } else { echo $seatcount;  }?>">
            <div class="imageBox_theImage" >
              ...
              <?php if(in_array($r,$seats)) { echo "";  } else { echo $seat->seat_no;  $seatcount++; } ?>
            </div>
          </div>
          <?php									 
									}
