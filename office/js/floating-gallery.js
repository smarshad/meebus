...
function saveImageOrder(vipseat,vipfares,buss_id,strid)
{
	//alert(strid);

	if(vipfares.value && vipseat.value !="" )
	{
		alert("VIP Seats are Mentioned");
	}
	var orderString = "";
	...
	/*document.getElementById('debug').innerHTML = 'This is the new order of Your seat <br>' + orderString;*/
	document.getElementById("debug").innerHTML+="<a href='edit_seatlayout.php?exists&val2="+orderString+"&busid="+buss_id+"&vipseatsel="+vipseat.value+"&vipfare="+vipfares.value+"&strid="+strid+"' onclick='' style='color: coral; text-decoration: none;'>FIX THIS STRUCTURE</a>";
	
	/*document.getElementById("debug").innerHTML+="<a href='edit_seatlayout.php?exists&val2="+orderString+"&busid=+buss_id+' onclick='' style='color: coral; text-decoration: none;'>Click Here</a>";*/
