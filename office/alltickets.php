...
<fieldset class="table-bor">
		...
		<input type="hidden" size="50" class="textbox2" onKeyUp="alltickets();" id="spnam" />
		<table width="100%" border="0" cellspacing="2" cellpadding="5">
		<!--<tr>
		<td colspan="4">
		<input type="radio" name="triptype" id="oneway" value="1" onChange="alltickets();" />&nbsp;&nbsp;&nbsp;One-Way
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="triptype" id="round" value="2" onChange="alltickets();" />&nbsp;&nbsp;&nbsp;Round Trip
		</td>
		</tr>-->
		  <tr>
									
			<td width="16%" align="left"> Ticket No </td>
			<td width="22%" >
