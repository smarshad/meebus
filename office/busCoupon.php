...
<table width="100%">
	<tr>		
		<td>			
			<input type="hidden" id="search_str" name="search_str" value="<?php echo $_SESSION['SP_id']; ?>" onKeyUp="searchcoup();" />		
	  </td>
	  <td>
	  Bus Type: <select name="bus_type" id="bus_type" onChange="searchcoup();">
	  ...
	  <td>From: <select name="from_bus" id="from_bus" onChange="searchcoup();">
	  ...
	  <?php
	   ...
	   <td>To: <select name="to_bus" id="to_bus" onChange="searchcoup();">
	  <option value="-1">None</option>
	   <?php
	  ...
	  <td>Status: <select name="bus_status" id="bus_status" onChange="searchcoup();">
	  <option value="-1">None</option>
