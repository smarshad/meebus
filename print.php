...
<html>
<head>
<?php include_once "header.php";if(isset($_POST['submit']) && $_POST['submit']=='Submit'){	$ticketnum=$_POST['ticketnum'];	$email=$_POST['email'];	$checkEmail=$obj->checkbusEmail(array($email,$ticketnum));	if($checkEmail!=0)	{		$data=array($ticketnum,$email);		$res=$obj->getTicketdetails($data);	}	else	{		$_SESSION['user']['bus']='Email ID AND Ticket Number Is Invalid';		header('location:printfailure.php');		exit;			}	} ?>
</head>
<body>
...
<div style="width: 660px; margin: 0px auto;">
     <!-- <img src="../images/email.png" style="display: none;">-->
      <img style=" float:right; cursor:pointer;" src="<?php echo $base_url;?>images/printer.png" onClick="PrintTicket('busTicket')">
    </div>
    <br clear="all">
<?php
